...
{
    public class Guest1UserProfileDemoViewModel : ViewModelBase, INotifyPropertyChanged
    {
        ...
        public Guest1UserProfileDemoViewModel(MyICommand stopDemoCommand, CancellationTokenSource demoStopper, User guest)
        {
        ...
        {
            string text = "Ovde možete videti svoj korisnički profil.";
